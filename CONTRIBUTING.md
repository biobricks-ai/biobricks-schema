# Contributing to biobricks-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
biobricks-schema. These guidelines are not strict rules.
...
The biobricks-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the biobricks-schema technical leads
...
[issues]: https://github.com/biobricks-ai/biobricks-schema/issues/
[pulls]: https://github.com/biobricks-ai/biobricks-schema/pulls/
